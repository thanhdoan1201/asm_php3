            ...
            <div class="double-scroll">
                <table class="table table-bordered">
                    ...
                    <tr>
                        ...
                        <td class="text-center">{{$a->name_lbds}}</td>

                        <td class="text-center">
                            <a href="{{route('route_BackEnd_Categorylands_Detail',$a->id)}}">
                            ...
                            <a href="{{route('route_BackEnd_Categorylands_Remove',$a->id)}}" onclick="return confirm('Bạn chắc chắn muốn xóa chứ ?')">
