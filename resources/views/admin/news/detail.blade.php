...
<section class="content appTuyenSinh">
    ...
    <form class="form-horizontal " action="{{ route('route_BackEnd_News_Update',['id'=>request()->route('id')]) }}" method="post" enctype="multipart/form-data">
        @csrf
        <div class="box-body">
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-8">
                            <input type="text" name="title_news" id="title_news" class="form-control" value="{{$objItem->title_news}}">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-8">
                            <textarea class="form-control" rows="5" id="content_news" name="content_news" value="">{{$objItem->content_news}}</textarea>
                            <span id="mes_sdt"></span>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-8">
                            <div class="row">
                                <div class="col-xs-6">
                                    <img id="images_news" src="{{$objItem->images?''.Storage::url($objItem->images):'https://banner2.cleanpng.com/20180702/oga/kisspng-newspaper-computer-icons-symbol-news-icon-5b3add8cb3a9a8.8956674115305844607359.jpg' }}" alt="your image" style="max-width: 200px; height:100px; margin-bottom: 10px;" class="img-fluid" />
