            ...
            <div class="double-scroll">
                <table class="table table-bordered">
                    <tr>
                        ...
                        <th class="text-center">Danh Mục Liên Quan</th>
                    ...
                    <tr>
                        ...
                        <td class="text-center">{{$a->title_news}}</td>
                        <td class="text-center content-news">
                            {{$a->content_news}}
                        </td>
                        <td class="text-center"><img src="{{asset("storage/".$a->images)}}" alt="" style="width:250px; height:100px; margin-bottom: 10px;" class="img-responsive"></td>
                        <td class="text-center">
                            <a href="{{route('route_BackEnd_News_Detail',$a->id)}}">
                            ...
                            <a href="{{route('route_BackEnd_News_Remove',$a->id)}}" onclick="return confirm('Bạn chắc chắn muốn xóa chứ ?')">
