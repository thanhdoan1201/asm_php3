            ...
            <div class="double-scroll">
                <table class="table table-bordered">
                    <tr>
                        ...
                        <th class="text-center">ID tin tức</th>
                    ...
                    <tr>
                        ...
                        <td class="text-center">{{$a->name_banner}}</td>
                        <td class="text-center"><button style="padding-inline: 15px; "><strong><a href="/news?id={{$a->id_news}}" target="_blank">{{$a->id_news}}</a></strong></button></td>
                        <td class="text-center"><img src="{{asset("storage/".$a->image)}}" style="width:350px; height:150px; margin-bottom: 10px;" class="img-responsive"></td>
                        <td class="text-center">
                        <a href="{{route('route_BackEnd_Banner_Detail',$a->id)}}">
                            ...
                            <a href="{{route('route_BackEnd_Banner_Remove',$a->id)}}" onclick="return confirm('Bạn chắc chắn muốn xóa chứ ?')">
