...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('public_admin/default/plugins/iCheck/all.css')}}">

    <!-- Theme style -->
    <link rel="stylesheet" href="{{ asset('public_admin/default/dist/css/AdminLTE.min.css')}}">
    <!-- AdminLTE Skins. Choose a skin from the css/skins
         folder instead of downloading all of them to reduce the load. -->
    <link rel="stylesheet" href="{{ asset('public_admin/default/dist/css/skins/_all-skins.min.css')}}">
    <link rel="stylesheet" href="{{ asset('public_admin/default/dist/css/spx.css')}}">
    <link rel="stylesheet" href="{{ asset('public_admin/css/SpxApp.css')}}?b={{config('app.build_version')}}">
    <link rel="stylesheet" href="{{ asset('public_admin/css/backend.css')}}?b={{config('app.build_version')}}">
    ...
    <link rel="icon" type="image/png" sizes="16x16" href="/public/public_admin/img/favicon.png">
    ...
    {{--<script type="text/javascript" src="/public/public_admin/public/js/app.js?b={{config('app.build_version')}}"></script>--}}
    <script src="{{ asset('public_admin/default/bower_components/jquery/dist/jquery.min.js')}}"></script>
    {{--<script src="{{ taisan('/public/public_admin/public/default/dist/js/spx.js')}}"></script>--}}
...
<body class="hold-transition skin-blue sidebar-mini fixed">
        ...
        <aside class="main-sidebar">
            ...
            <section class="sidebar">
                ...
                <ul class="sidebar-menu" data-widget="tree">
                    ...
                    <li class=" active menu-open ">
                        <a href="#"><i class="fa fa-user"></i> <span>Loại BĐS</span></a>
                        <ul class="treeview-menu">
                            <li><a href="{{route('route_BackEnd_Categorylands_List')}}"><i class="fa fa-circle-o"></i> Danh Sách Loại BĐS</a></li>
                            <li><a href="{{route('route_BackEnd_Categorylands_Add')}}"><i class="fa fa-circle-o"></i> Thêm Loại BĐS</a></li>
                        </ul>
                    </li>
                    <li class=" active menu-open ">
                        <a href="#"><i class="fa fa-user"></i> <span>Bất Động Sản</span></a>
                        <ul class="treeview-menu">
                            <li><a href="{{route('route_BackEnd_Lands_List')}}"><i class="fa fa-circle-o"></i> Danh Sách BĐS</a></li>
                            <li><a href="{{route('route_BackEnd_Lands_Add')}}"><i class="fa fa-circle-o"></i> Thêm BĐS</a></li>
                    ...
                    <li class=" active menu-open ">
                        ...
                        <ul class="treeview-menu">
                            <li><a href="{{route('route_BackEnd_News_List')}}"><i class="fa fa-circle-o"></i> Danh Sách Tin Tức</a></li>
                            <li><a href="{{route('route_BackEnd_News_Add')}}"><i class="fa fa-circle-o"></i> Thêm Tin Tức</a></li>
                        </ul>
                    </li>
                    <li class=" active menu-open ">
                        <a href="#"><i class="fa fa-user"></i> <span>Banner</span></a>
                        <ul class="treeview-menu">
                            <li><a href="{{route('route_BackEnd_Banner_List')}}"><i class="fa fa-circle-o"></i> Danh Sách Banner</a></li>
                            <li><a href="{{route('route_BackEnd_Banner_Add')}}"><i class="fa fa-circle-o"></i> Thêm Banner</a></li>
                        </ul>
                    </li>
                </ul>
            </section>
    ...
    <!-- SlimScroll -->
    <script src="{{ asset('public_admin/default/bower_components/jquery-slimscroll/jquery.slimscroll.min.js')}}"></script>
    <!-- FastClick -->
    <script src="{{ asset('public_admin/default/bower_components/fastclick/lib/fastclick.js')}}"></script>
    <!-- iCheck 1.0.1 -->
    <script src="{{ asset('public_admin/default/plugins/iCheck/icheck.min.js')}}"></script>
    <!-- jquery cookie -->
    <script src="{{ asset('public_admin/default/plugins/jquery-cookie/jquery.cookie.js')}}"></script>
    {{--<script src="/public/public_admin/default/plugins/iCheck/icheck.min.js"></script>--}}
    <script src="{{ asset('public_admin/default/bower_components/select2/dist/js/select2.full.min.js') }}"></script>

    <!-- AdminLTE App -->
    <script src="{{ asset('public_admin/default/dist/js/adminlte.min.js')}}"></script>
    <!-- AdminLTE for demo purposes -->
    <script src="{{ asset('public_admin/default/dist/js/demo.js')}}"></script>
    <script src="{{ asset('public_admin/js/jquery.doubleScroll.js')}}?b=1 "></script>
    <script src="{{ asset('public_admin/js/SpxApp.js')}}?b=1"></script>
    {{--<script src="{{ taisan('/public/public_admin/js/backend.js')}}?b={{config('app.build_version')}}"></script>--}}
